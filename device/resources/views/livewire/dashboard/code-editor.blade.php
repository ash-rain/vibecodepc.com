<div class="flex flex-col h-screen">
    ...
    {{-- Warning: Not paired warning --}}
    @if (! $isPaired)
        <div class="bg-yellow-500/10 border-b border-yellow-500/30 px-4 py-2 shrink-0">
            <div class="flex items-center gap-3">
                ...
                <p class="text-yellow-400 text-xs">
                    ...
                    Code Server is only available on local network (http://localhost:8443 or http://&lt;your-device-hostname&gt;:8443).
                    <a href="{{ route('dashboard.tunnels') }}" class="underline hover:text-yellow-300">Set up remote access</a> to access from anywhere.
                </p>
            </div>
        </div>
    @endif
