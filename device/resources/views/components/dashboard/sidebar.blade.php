...
<x-dashboard.nav-item route="dashboard.ai-tools" label="AI Tools Config"
...
/>
    ...
    <x-dashboard.nav-item route="dashboard.ai-agents" label="AI Agent Configs"
    ...
    <x-dashboard.nav-item route="dashboard.barx" label="Barx Config"
...
<div class="pt-4 mt-4 border-t border-white/[0.06]">
    <x-dashboard.nav-item route="dashboard.analytics" label="Analytics"
    ...
    <div class="px-4 py-3 border-t border-white/[0.06]">
        <div class="text-xs text-gray-500">VibeCodePC Device</div>
    </div>
</aside>
